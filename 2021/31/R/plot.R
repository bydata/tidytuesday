pacman::p_load("tidyverse", "tidytuesdayR", "lubridate", "ggtext", 
               "colorspace", "wesanderson", "extrafont", "ggraph", "tidygraph", "patchwork")
...
plot <- oly %>% 
  ...
  # exclude Germany 1972 soviet Union 1980
